...
if (GIR_SCANNER_BIN AND GIR_COMPILER_BIN)
    ...
    macro (gir_build module namespace)
        add_custom_target ("g-ir-scanner_${module}" ALL
            ${GIR_SCANNER_BIN} -Imidori -I${CMAKE_SOURCE_DIR}/Source/midori -I${CMAKE_BINARY_DIR}/midori -I${CMAKE_SOURCE_DIR}/${module} -I${CMAKE_SOURCE_DIR}/Source/midori/toolbars -I.
