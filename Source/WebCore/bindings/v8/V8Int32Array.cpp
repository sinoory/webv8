...
WrapperTypeInfo V8Int32Array::info = { V8Int32Array::GetTemplate, V8Int32Array::derefObject, 0, &V8ArrayBufferView::info };
...
{
    INC_STATS("DOM.Int32Array.length._get");
...
static const BatchedAttribute Int32ArrayAttrs[] = {
    // Attribute 'length' (Type: 'readonly attribute' ExtAttr: '')
    {"length", Int32ArrayInternal::lengthAttrGetter, 0, 0 /* no data */, static_cast<v8::AccessControl>(v8::DEFAULT), static_cast<v8::PropertyAttribute>(v8::None), 0 /* on instance */},
};
static const BatchedCallback Int32ArrayCallbacks[] = {
    {"subarray", Int32ArrayInternal::subarrayCallback},
...
static v8::Persistent<v8::FunctionTemplate> ConfigureV8Int32ArrayTemplate(v8::Persistent<v8::FunctionTemplate> desc)
{
    v8::Local<v8::Signature> defaultSignature = configureTemplate(desc, "Int32Array", V8ArrayBufferView::GetTemplate(), V8Int32Array::internalFieldCount,
        Int32ArrayAttrs, WTF_ARRAY_LENGTH(Int32ArrayAttrs),
        Int32ArrayCallbacks, WTF_ARRAY_LENGTH(Int32ArrayCallbacks));
        desc->SetCallHandler(V8Int32Array::constructorCallback);
    v8::Local<v8::ObjectTemplate> instance = desc->InstanceTemplate();
    v8::Local<v8::ObjectTemplate> proto = desc->PrototypeTemplate();
    
    batchConfigureConstants(desc, proto, Int32ArrayConsts, WTF_ARRAY_LENGTH(Int32ArrayConsts));
...
v8::Handle<v8::Object> V8Int32Array::wrapSlow(Int32Array* impl)
{
