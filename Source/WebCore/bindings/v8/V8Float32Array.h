...
public:
    ...
    inline static v8::Handle<v8::Object> wrap(Float32Array*);
...
private:
    static v8::Handle<v8::Object> wrapSlow(Float32Array*);
};
...
v8::Handle<v8::Object> V8Float32Array::wrap(Float32Array* impl)
{
        ...
        if (!wrapper.IsEmpty())
            return wrapper;
    return V8Float32Array::wrapSlow(impl);
}

v8::Handle<v8::Value> toV8(Float32Array*);
inline v8::Handle<v8::Value> toV8(PassRefPtr< Float32Array > impl)
{
